...
print("\n\n Titre  \n")
for x in soup.body.find_all(class_="biGQs _P fiohW qWPrE ncFvv fOtGX"):
    print(x.text)
...
print("\n\n Commentaire  \n")
for x in soup.body.find_all(class_="yCeTE"):
    print(x.text)

#Date du séjour
#<div class="RpeCd">oct. 2022 • En famille</div>
print("\n\n Date Séjour  \n")
for x in soup.body.find_all(class_="RpeCd"):
    print(x.text)

#Date du commentaire
#<div class="biGQs _P pZUbB ncFvv osNWb">Écrit le 9 novembre 2022</div>
print("\n\n Date Commentaire  \n")
for x in soup.body.find_all(class_="biGQs _P pZUbB ncFvv osNWb"):
    print(x.text)
